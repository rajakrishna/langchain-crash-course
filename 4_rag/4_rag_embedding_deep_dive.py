...
# google_gen_ai_embeddings = GoogleGenerativeAIEmbeddings(model="models/text-embedding-004")
# create_vector_store(docs, google_gen_ai_embeddings, "chroma_db_google_gen_ai")
